...
## Parse Input
This file is where we take the input from the yosys conversion output and outputs the logic circuit in them as a predefined gates with nested lists of inputs and outputs.
